...
no_coop = np.load("results/attacked/%d/average_train_loss_no-cooperation.npy" % attacker_num)
no_coop_acc = np.load("results/attacked/%d/average_train_acc_no-cooperation.npy" % attacker_num)
...
ave = np.load("results/attacked/%d/average_train_loss_average.npy" % attacker_num)
ave_acc = np.load("results/attacked/%d/average_train_acc_average.npy" % attacker_num)

ave.tolist()
print("loss-ave", ave)
print("acc-ave", ave_acc)

loss = np.load("results/attacked/%d/average_train_loss_loss.npy" % attacker_num)
loss_acc = np.load("results/attacked/%d/average_train_acc_loss.npy" % attacker_num)
#loss =  20*np.log(np.load("results/attacked/average_train_loss_loss.npy"))
loss.tolist()
print("loss-loss", loss)
print("acc-loss", loss_acc)

distance = np.load("results/attacked/%d/average_train_loss_distance.npy" % attacker_num)
distance_acc = np.load("results/attacked/%d/average_train_acc_distance.npy" % attacker_num)
...
no_coop_test = np.load("results/attacked/%d/average_test_loss_no-cooperation.npy" % attacker_num)
no_coop_acc_test = np.load("results/attacked/%d/average_test_acc_no-cooperation.npy" % attacker_num)
...
ave_test = np.load("results/attacked/%d/average_test_loss_average.npy" % attacker_num)
ave_acc_test = np.load("results/attacked/%d/average_test_acc_average.npy" % attacker_num)

ave_test.tolist()
print("loss-ave_test",ave_test)
print("acc-ave_test",ave_acc_test)

loss_test = np.load("results/attacked/%d/average_test_loss_loss.npy" % attacker_num)
loss_acc_test = np.load("results/attacked/%d/average_test_acc_loss.npy" % attacker_num)
...
distance_test = np.load("results/attacked/%d/average_test_loss_distance.npy" % attacker_num)
distance_acc_test = np.load("results/attacked/%d/average_test_acc_distance.npy" % attacker_num)
#loss_test =  20*np.log(np.load("results/attacked/average_test_loss_loss.npy"))
distance_test.tolist()
